...
def download_data() -> None:
    urllib.request.urlretrieve("https://d37ci6vzurychx.cloudfront.net/trip-data/yellow_tripdata_2021-01.parquet", TRAIN_PATH)
    urllib.request.urlretrieve("https://d37ci6vzurychx.cloudfront.net/trip-data/yellow_tripdata_2021-02.parquet", TEST_PATH)
    urllib.request.urlretrieve("https://d37ci6vzurychx.cloudfront.net/trip-data/yellow_tripdata_2021-03.parquet", PREDICT_PATH)
...
def complete_ml(train_path: str, test_path: str, save_model: bool = True, save_dv: bool = True, local_storage: str = LOCAL_STORAGE) -> None:
    """
...
def batch_inference(input_path, dv=None, model=None, local_storage=LOCAL_STORAGE) -> np.ndarray:
    """
